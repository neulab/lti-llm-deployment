...
# Note: this is a minimalistic copy of transformers.generation_utils and only
# supports greedy decoding and sampling
...
class GenerationMixin(BaseGenerationMixin):
    ...
    def greedy_search(
        ...
        **model_kwargs,
        ...
        num_generated_tokens = input_ids.new(input_ids.shape[0]).fill_(0)
        ...
        while True:
            ...
            if eos_token_id is not None:
                ...
                num_generated_tokens += unfinished_sequences
